...
if(isset($_POST['submit']))
{
	...
	else
	{
		...
		if(mysqli_affected_rows($con) == 1)
		{
			echo "<script>alert('winne record inserted successfully..');</script>";
			echo "<script>window.location='winne.php';</script>";
		}
		else
		{
			echo mysqli_error($con);
...
if(isset($_GET['editid']))
{
	...
	$edit = mysqli_fetch_array($qsqledit);
}
?>
...
<div class="col-lg-12">
	<p class="single-form-row">
		...
		<input type="text" name="bidding_amount" id="bidding_amount" class="form-control" value="<?php echo $edit['bidding_amount']; ?>" >
	</p>
</div>			
...
<div class="col-lg-12">
	<p class="single-form-row">
		...
		<input type="datetime" name="bidding_date_time" id="bidding_date_time" class="form-control" value="<?php echo $edit['bidding_date_time']; ?>" >
	</p>
</div>	
