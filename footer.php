...
if(!isset($_SESSION['customer_id']))
{
	...
	<div class="col-lg-3 col-md-6 col-sm-6">
		...
		<ul>
			...
			<li><a href="employeelogin.php?logintype=Employee">Seller Login</a></li>
		</ul>
	</div>
	<?php
	}
	...
	<div class="col-lg-3 col-md-6 col-sm-6">
		...
		<ul>
			<li><a href="empprofile.php">Seller Profile</a></li>
...
?>
                                        ...
                                        <div class="col-lg-5 offset-xl-1 col-md-6 col-sm-6">
                                            ...
                                            <div class="block-contact-text">
                                                <p> E-Auction<br>Leading University<br>Bangladesh</p>
                                                <p>Call us: <span>+88-01796362810 </span></p>
                                                <p>Email us: <span>contact@topsyturvy</span></p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
