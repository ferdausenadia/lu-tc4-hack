...
<form action="" method="post"> 
	<p class="coupon-input form-row-first">
		...
		<label>Last Name<span class="required">*</span> <span class="errormsg"  id="errcustomer"></span></label>
	...
	<p class="coupon-input form-row-first">
		...
		<input type="text" name="mobile_no" id="mobile_no" value="+88" onkeypress="return isNumber(event)" >
	</p>
...
function validatecustomer()
{
	...
	{
		document.getElementById("errcustomer_name").innerHTML=" name not contain less than 15 characters...";
		errchk = "True";
	}
	if(document.getElementById("customer").value.length > 25)
	{
		document.getElementById("errcustomer").innerHTML=" name not contain less than 15 characters...";
		errchk = "True";
	}
	if(!document.getElementById("customer_name").value.match(alphaSpaceExp))
	{
		document.getElementById("errcustomer_name").innerHTML = "Kindly enter valid name..";
		errchk = "True";
	}
	if(!document.getElementById("customer").value.match(alphaSpaceExp))
	{
		document.getElementById("errcustomer").innerHTML = "Kindly enter valid name..";
		errchk = "True";
	}
	if(document.getElementById("customer_name").value == "")
	{
		document.getElementById("errcustomer_name").innerHTML=" name should not be empty...";
		errchk = "True";
	}
	if(document.getElementById("customer").value == "")
	{
		document.getElementById("errcustomer").innerHTML=" name should not be empty...";
		errchk = "True";
	}
	...
	*/
	...
	{
		document.getElementById("errmobile_no").innerHTML="Mobile Number should contain 11 digits..";
		errchk = "True";
	}
