...
?>				
		...
		{
			$arr_pro_img = unserialize($bdt['product_image']);
			 $sqlbidding = "SELECT * from bidding WHERE product_id='" . $bdt['product_id'] . "'";
...
{
?>
  <img class="mySlides<?php echo $bdt[0]; ?> w3-animate-fading" src="imgproduct/<?php echo $arr_pro_img[$iimg]; ?>" style="width:100%">
<?php
}
?>
</div>
...
function carousel() {
  var i;
  var x = document.getElementsByClassName("mySlides<?php echo $bdt[0]; ?>");
