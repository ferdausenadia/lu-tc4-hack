...
<div class="col-md-4">
	<figure class="card card-product">
		<div class="img-wrap">
			<center>
				<a href="single.php?productid=<?php echo $rstproduct[0]; ?>"><img src="<?php echo $imgname; ?>" alt=" " class="img-responsive"style="height: 250px;" /></a>
			</center>
		</div>
...
<div class="label-rating"><span>Started on <?php echo date("d-M-Y h:i A",strtotime($rsproduct['start_date_time']));?></span><br></div>
		...
		<div class="bottom-wrap">
				...
				<div class="price-wrap h5">
					<span class="price-new">Starting bid : bdt<?php echo $rsproduct['starting_bid']; ?></span> 
